(() => {
    const TRANSLATIONS = {
      pt: {
        ...
        setup: {
          ...
          difficultySub: 'Filtra desafios e ajusta bônus de pontuação.',
          ...
          dailyChallengeLabel: 'Desafio Diário',
          dailyChallengeSub: 'Usa o mesmo conjunto do dia e salva no placar diário.',
        ...
        final: {
          ...
          shareDailyResult: 'Compartilhar diário',
          tie: 'EMPATE!'
        },
        leaderboard: {
          ...
          filter: {
            ...
            scope: 'Escopo',
            standard: 'Partidas',
            standardSub: 'Ranking das partidas normais',
            daily: 'Diário',
            dailySub: 'Ranking dos desafios do dia',
        ...
        dynamic: {
          ...
          dailyShareText: ({ date, winner, score }) => `EmojiDecoder diário ${date} · Vencedor: ${winner} · ${score}`,
        ...
        notifications: {
          ...
          dailyResultCopied: '✅ Resultado diário copiado!',
      ...
      en: {
        ...
        setup: {
          ...
          difficultySub: 'Filters challenges and adjusts score bonus.',
          ...
          dailyChallengeSub: 'Uses the same daily set and saves it to the daily leaderboard.',
        ...
        final: {
          ...
          shareDailyResult: 'Share daily result',
          tie: 'TIE!'
        },
        leaderboard: {
          ...
          filter: {
            ...
            scope: 'Scope',
            standard: 'Matches',
            standardSub: 'Regular match ranking',
            daily: 'Daily',
            dailySub: 'Daily challenge ranking',
        ...
        dynamic: {
          ...
          dailyShareText: ({ date, winner, score }) => `EmojiDecoder daily ${date} · Winner: ${winner} · ${score}`,
        ...
        notifications: {
          ...
          dailyResultCopied: '✅ Daily result copied!',
      ...
      es: {
        ...
        setup: {
          ...
          difficultySub: 'Filtra desafíos y ajusta el bono de puntuación.',
    ...
    TRANSLATIONS.fr = mergeTranslations(TRANSLATIONS.en, {
      ...
      setup: {
        ...
        difficultySub: 'Filtre les défis et ajuste le bonus de score.',
    ...
    TRANSLATIONS.de = mergeTranslations(TRANSLATIONS.en, {
      ...
      setup: {
        ...
        difficultySub: 'Filtert Herausforderungen und passt den Punktebonus an.',
    ...
    TRANSLATIONS.it = mergeTranslations(TRANSLATIONS.en, {
      ...
      setup: {
        ...
        difficultySub: 'Filtra le sfide e regola il bonus punteggio.',
  ...
  const emojiDecoderPtPatch = {
    meta: { documentTitle: 'EmojiDecoder' },
    home: {
      title: 'EmojiDecoder',
      subtitle: 'Decifre emojis, revele respostas e vença a rodada',
      howTo: {
        setupDesc: 'Escolha times ou duelo, defina rodadas e categorias de desafios.',
        turnTitle: 'Decifre a sequência',
        turnDesc: 'Um jogador vê os emojis e tenta descobrir o objeto, pessoa, filme, lugar, marca ou expressão.',
        timerDesc: 'O cronômetro mantém cada palpite rápido e competitivo.',
        winDesc: 'Quem acertar marca pontos. No fim, o placar decide o vencedor.'
      }
    },
    multiDevice: {
      hostDesc: 'Este dispositivo controla a partida. O dispositivo auxiliar alterna entre timer e desafio durante a rodada.',
      liveDrawing: '🧩 Desafio na tela auxiliar',
      guestMemorizing: 'Prepare-se! O desafio aparece em instantes.',
      guestPlaying: 'Hora de decodificar!',
      guestJokeTurn: 'Sua vez de decifrar na tela auxiliar.',
      guestSecretAnswer: 'Nome secreto para validação',
      guestAnswerRevealed: 'Resposta revelada',
      assignmentSub: 'Escolha o time ou jogador que vai decifrar usando o dispositivo conectado.'
    },
    setup: {
      title: 'Nova Partida',
      gameTypeTitle: '1️⃣ Exibição do desafio',
      gameTypeMimeName: 'Tela principal',
      gameTypeMimeDesc: 'O desafio aparece neste dispositivo',
      gameTypeDrawingName: 'Tela auxiliar',
      gameTypeDrawingDesc: 'O desafio aparece no dispositivo conectado',
      randomChallengeLabel: 'Modo de palpite',
      randomChallengeSub: 'Sorteia uma regra divertida para responder',
      buzzModeLabel: 'Modo Disputa',
      buzzModeSub: 'Todos podem responder; no resultado o host escolhe quem acertou primeiro.',
      stealModeLabel: 'Modo Roubo',
      stealModeSub: 'Quando ninguém acerta, o próximo jogador pode roubar metade dos pontos.',
      comboModeLabel: 'Modo Combo',
      comboModeSub: 'Acertos consecutivos do mesmo jogador multiplicam a pontuação, e erro reseta a sequência.',
      typedGuessModeLabel: 'Palpite digitado',
      typedGuessModeSub: 'Permite validar texto com tolerância a maiúsculas, acentos e artigos.',
      dailyChallengeLabel: 'Desafio Diário',
      dailyChallengeSub: 'Usa o mesmo conjunto do dia e salva no placar diário.',
      difficultySub: 'Filtra desafios e ajusta bônus de pontuação.',
      categoriesLabel: 'Categorias de desafios',
      coreCategoriesLabel: 'Categorias Core',
      scoringTradeoff: 'Acertos rápidos valem bônus; pedir dica e errar reduzem pontos. Use 0 em Configurações para desativar penalidade.',
      startGame: '🧩 Começar rodada!'
    },
    category: {
      objetos: { plural: 'Objetos', singular: 'Objeto', tab: '🧩 Objetos', option: '🧩 Objetos' },
      pessoas: { plural: 'Pessoas', singular: 'Pessoa', tab: '🧑 Pessoas', option: '🧑 Pessoas' },
      filmes_series: { plural: 'Filmes e Séries', singular: 'Filme ou Série', tab: '🎬 Filmes & Séries', option: '🎬 Filmes & Séries' },
      lugares: { plural: 'Lugares', singular: 'Lugar', tab: '🗺️ Lugares', option: '🗺️ Lugares' },
      marcas: { plural: 'Marcas', singular: 'Marca', tab: '🏷️ Marcas', option: '🏷️ Marcas' },
      expressoes: { plural: 'Expressões', singular: 'Expressão', tab: '💬 Expressões', option: '💬 Expressões' }
    },
    game: {
      currentPlayerLabel: 'Vez de decodificar:',
      currentPlayerDrawingLabel: 'Vez de decodificar no dispositivo auxiliar:',
      readyTitle: 'Prontos para decifrar?',
      readyDrawingTitle: 'Prontos para enviar o desafio ao dispositivo auxiliar?',
      readySub: 'Mostre o desafio e tente descobrir a resposta antes do tempo acabar.',
      readyDrawingSub: 'Só quem vai decifrar no device auxiliar deve olhar.',
      revealWord: '🎲 Sortear desafio',
      startsIn: 'O desafio aparece em...',
      onlyMimeCanSee: 'Só quem vai responder pode ver!',
      onlyDrawerCanSee: 'Só o jogador do device auxiliar pode ver!',
      hiddenWord: 'Desafio oculto',
      hintTitle: '🏷️ Categoria',
      showWord: '👁️ Mostrar desafio',
      hideWord: '🙈 Ocultar desafio',
      wordOnCompanion: 'Desafio exibido na tela auxiliar',
      correct: '✅ Acertou!',
      wrong: '❌ Errou',
      secretAnswerLabel: 'Nome secreto',
      secretAnswerSub: 'Mostre esta resposta apenas para quem vai validar a rodada.',
      secretAnswerCompanionSub: 'Não mostre esta tela para quem está tentando acertar.',
      hintPrefix: ({ hint }) => `Dica: ${hint}`,
      rulePrefix: ({ rule }) => `Regra: ${rule}`,
      challengePrefix: '🧭 Pista:',
      requestHint: ({ points }) => `💡 Pedir dica (-${points} pts)`,
      hintRequested: '💡 Dica usada',
      hintCost: ({ points }) => `A dica reduz ${points} pontos do acerto.`,
      typedGuessPlaceholder: 'Digite o palpite...',
      submitTypedGuess: '⌨️ Validar palpite'
    },
    result: {
      correctTitle: 'Acertou!',
      wrongTitle: 'Errou!',
      timeUpTitle: 'Tempo encerrado!',
      feedbackTitle: 'Como foi esse desafio?',
      feedbackSubtitle: 'Sua avaliação local ajuda a priorizar melhores desafios.',
      answerReveal: ({ answer }) => `Resposta: ${answer}`,
      guesserLabel: 'Quem acertou primeiro?',
      guesserPlaceholder: 'Selecione quem acertou',
      buzzPickPrompt: 'Escolha quem acertou primeiro para aplicar os pontos.',
      stealTitle: 'Roubo disponível',
      stealSummary: ({ playerName, points }) => `${playerName} pode roubar ${points} pontos.`,
      stealButton: '⚡ Roubo acertou',
      shareDailyResult: 'Compartilhar diário',
      neverAgain: '🚫 Não repetir',
      nextTurn: '➡️ Próximo turno'
    },
    leaderboard: {
      subtitle: 'Ranking dos melhores decodificadores em todas as partidas registradas.',
      tab: { mime: 'Tela principal', drawing: 'Tela auxiliar' }
    },
    achievements: {
      laughsLabel: 'Acertos acumulados',
      items: {
        firstLaugh: { title: 'Primeiro Acerto', desc: 'Decifre seu primeiro desafio.' },
        firstNoLaugh: { title: 'Primeiro Erro', desc: 'Registre sua primeira rodada sem acerto.' },
        humorBeginner: { title: 'Decodificador Iniciante', desc: 'Acumule 10 acertos.' },
        laughterMachine: { title: 'Decodificador Mestre', desc: 'Acumule 50 acertos.' },
        jokeMarathon: { title: 'Maratona de Emojis', desc: 'Jogue 100 rodadas.' },
        funnyStreak: { title: 'Sequência Certeira', desc: 'Consiga 3 acertos seguidos.' },
        unstoppable: { title: 'Imparável', desc: 'Consiga 5 acertos seguidos.' }
      },
      templates: {
        laughsTitle: ({ count }) => `Acertos x${count}`,
        laughsDesc: ({ count }) => `Acumule ${count} acertos.`,
        noLaughsTitle: ({ count }) => `Erros x${count}`,
        noLaughsDesc: ({ count }) => `Registre ${count} rodadas sem acerto.`,
        streakDesc: ({ count }) => `Consiga ${count} acertos seguidos.`
      }
    },
    wordbank: {
      addTitle: '➕ Adicionar desafio',
      newWordPlaceholder: 'Digite os emojis do desafio...',
      newAnswerPlaceholder: 'Digite a resposta correta...',
      newHintPlaceholder: 'Digite uma dica curta...',
      addButton: '➕ Adicionar desafio',
      listTitle: '📋 Desafios',
      answerMeta: ({ answer }) => `Resposta: ${answer}`,
      hintMeta: ({ hint }) => `Dica: ${hint}`,
      emptyCategory: 'Nenhum desafio nesta categoria ainda.',
      challengesEmpty: 'Nenhuma regra de palpite ativa. Restaure ou adicione uma nova.',
      installPackSub: 'Envie um arquivo .json para liberar novos desafios neste dispositivo.',
      packPreviewPrompt: 'Clique em um pack instalado para ver desafios e regras.',
      packPreviewWordsTitle: 'Desafios do pack',
      jokeRankingTitle: '🏅 Ranking local de desafios',
      curationTopRated: 'Melhores avaliados',
      curationHighSuccess: 'Alta taxa de acerto',
      curationNeedsReview: 'Revisar conteúdo',
      curationNeverAgain: 'Marcados como não repetir',
      curationAllStats: 'Todos com estatísticas',
      packCreatorTitle: '🧰 Criador de Packs',
      packCreatorNamePlaceholder: 'Nome do pack...',
      packCreatorDescriptionPlaceholder: 'Descrição curta...',
      packCreatorSub: 'Exporta os desafios locais no schema v1 para importar em outro dispositivo.',
      exportLocalPack: 'Exportar pack JSON',
      shareLocalPack: 'Compartilhar por link/QR',
      clearJokeStats: 'Limpar estatísticas de desafios'
    },
    settings: {
      roundTimeSub: 'Segundos para decifrar o desafio',
      prepareTimeSub: 'Segundos antes do desafio aparecer',
      correctPointsLabel: 'Pontos por acerto',
      correctPointsSub: 'Pontos para quem decifra corretamente',
      speedBonusLabel: 'Bônus por velocidade',
      speedBonusSub: 'Dá pontos extras para acertos rápidos',
      speedBonusMaxLabel: 'Bônus máximo',
      speedBonusMaxSub: 'Pontos extras quando acertar no começo do timer',
      wrongPenaltyPointsLabel: 'Pontos perdidos por erro',
      wrongPenaltyPointsSub: 'Desconta pontos quando errar ou o tempo acabar. Use 0 para desativar.',
      roundFlowSub: 'Preparação curta, desafio visível e marcação rápida de acerto',
      wordsTitle: '🎲 Desafios',
      shuffleWordsLabel: 'Embaralhar desafios',
      shuffleWordsSub: 'Ordem aleatória a cada partida'
    },
    donate: {
      title: 'Apoie EmojiDecoder',
      whyUpdates: 'Também ajuda a manter EmojiDecoder atualizado com polimento, balanceamento e novos recursos.'
    },
    share: {
      title: 'EmojiDecoder',
      text: 'Vem jogar EmojiDecoder comigo!',
      footerAriaLabel: 'Compartilhar EmojiDecoder'
    },
    footer: {
      copyPrefix: '© 2026 EmojiDecoder v0.1 · Insight X Lab Technologies'
    },
    notifications: {
      duplicateWord: '⚠️ Desafio já existe!',
      challengeFieldsRequired: '⚠️ Informe emojis e resposta.',
      guessIncorrect: '❌ Palpite incorreto.',
      guessSent: '📨 Palpite enviado ao host.',
      dailyResultCopied: '✅ Resultado diário copiado!',
      localPackExported: '✅ Pack local exportado!',
      localPackShareCopied: '🔗 Link do pack copiado e QR gerado!',
      jokeStatsCleared: '✅ Estatísticas de desafios limpas!'
    },
    dynamic: {
      wordAdded: ({ word, category }) => `✅ Desafio adicionado em ${category}: "${word}"`,
      correctScoreBreakdown: ({ base, speedBonus = 0, difficultyBonus = 0, hintPenalty = 0, comboMultiplier = 1, total }) => {
        const parts = [`Base ${base}`];
        if (speedBonus > 0) parts.push(`+ velocidade ${speedBonus}`);
        if (difficultyBonus > 0) parts.push(`+ dificuldade ${difficultyBonus}`);
        if (hintPenalty > 0) parts.push(`- dica ${hintPenalty}`);
        if (comboMultiplier > 1) parts.push(`x combo ${comboMultiplier}`);
        return parts.length > 1 ? `${parts.join(' ')} = ${total}` : parts[0];
      },
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} para ${playerName} e ${teamName}!`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} para ${playerName}!`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Roubo: +${points} para ${playerName} e ${teamName}!`,
      stealPlayerPoints: ({ playerName, points }) => `Roubo: +${points} para ${playerName}!`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder diário ${date} · Vencedor: ${winner} · ${score}`
    },
    confirmations: {
      clearJokeStats: 'Apagar todas as estatísticas locais de desafios deste dispositivo?',
      resetWords: 'Restaurar o banco de desafios padrão? Os desafios personalizados serão perdidos.'
    },
    userIdErrors: {
      invalidSchema: 'Este arquivo não é um backup de user_id do EmojiDecoder.'
    }
  };

  const emojiDecoderEnPatch = {
    meta: { documentTitle: 'EmojiDecoder' },
    home: {
      title: 'EmojiDecoder',
      subtitle: 'Decode emojis, reveal answers, and win the round'
    },
    category: {
      objetos: { plural: 'Objects', singular: 'Object', tab: '🧩 Objects', option: '🧩 Objects' },
      pessoas: { plural: 'People', singular: 'Person', tab: '🧑 People', option: '🧑 People' },
      filmes_series: { plural: 'Movies & Series', singular: 'Movie or Series', tab: '🎬 Movies & Series', option: '🎬 Movies & Series' },
      lugares: { plural: 'Places', singular: 'Place', tab: '🗺️ Places', option: '🗺️ Places' },
      marcas: { plural: 'Brands', singular: 'Brand', tab: '🏷️ Brands', option: '🏷️ Brands' },
      expressoes: { plural: 'Sayings', singular: 'Saying', tab: '💬 Sayings', option: '💬 Sayings' }
    },
    setup: {
      buzzModeLabel: 'Buzz mode',
      buzzModeSub: 'Everyone may answer; in the result the host picks who solved first.',
      stealModeLabel: 'Steal mode',
      stealModeSub: 'When nobody solves, the next player may steal half the points.',
      comboModeLabel: 'Combo mode',
      comboModeSub: 'Consecutive solves by the same player multiply the score, and a miss resets the streak.',
      typedGuessModeLabel: 'Typed guess',
      typedGuessModeSub: 'Validates text while ignoring case, accents, and articles.',
      dailyChallengeLabel: 'Daily Challenge',
      dailyChallengeSub: 'Uses the same daily set and saves it to the daily leaderboard.',
      difficultySub: 'Filters challenges and adjusts score bonus.',
      scoringTradeoff: 'Fast correct answers earn bonuses; hints and mistakes reduce points. Use 0 in Settings to disable the penalty.'
    },
    game: {
      currentPlayerLabel: 'Decoder turn:',
      revealWord: '🎲 Draw challenge',
      correct: '✅ Correct!',
      wrong: '❌ Wrong',
      secretAnswerLabel: 'Secret answer',
      secretAnswerSub: 'Show this answer only to the person validating the round.',
      secretAnswerCompanionSub: 'Do not show this screen to the player who is guessing.',
      hintPrefix: ({ hint }) => `Hint: ${hint}`,
      rulePrefix: ({ rule }) => `Rule: ${rule}`,
      wordOnCompanion: 'Challenge shown on companion screen',
      requestHint: ({ points }) => `💡 Request hint (-${points} pts)`,
      hintRequested: '💡 Hint used',
      hintCost: ({ points }) => `The hint reduces the correct score by ${points} points.`,
      typedGuessPlaceholder: 'Type the guess...',
      submitTypedGuess: '⌨️ Validate guess'
    },
    multiDevice: {
      guestSecretAnswer: 'Secret answer for validation',
      guestAnswerRevealed: 'Answer revealed'
    },
    wordbank: {
      newWordPlaceholder: 'Type the emoji clue...',
      newAnswerPlaceholder: 'Type the correct answer...',
      newHintPlaceholder: 'Type a short hint...',
      answerMeta: ({ answer }) => `Answer: ${answer}`,
      hintMeta: ({ hint }) => `Hint: ${hint}`,
      emptyCategory: 'No challenges in this category yet.',
      challengesEmpty: 'No guessing rules active. Restore or add a new one.',
      curationTopRated: 'Top rated',
      curationHighSuccess: 'High success rate',
      curationNeedsReview: 'Needs review',
      curationNeverAgain: 'Marked do not repeat',
      curationAllStats: 'All with stats',
      packCreatorTitle: '🧰 Pack Creator',
      packCreatorNamePlaceholder: 'Pack name...',
      packCreatorDescriptionPlaceholder: 'Short description...',
      packCreatorSub: 'Exports local challenges in schema v1 for import on another device.',
      exportLocalPack: 'Export JSON pack',
      shareLocalPack: 'Share by link/QR'
    },
    notifications: {
      duplicateWord: '⚠️ Challenge already exists!',
      challengeFieldsRequired: '⚠️ Add emojis and answer.',
      guessIncorrect: '❌ Incorrect guess.',
      guessSent: '📨 Guess sent to host.',
      dailyResultCopied: '✅ Daily result copied!',
      localPackExported: '✅ Local pack exported!',
      localPackShareCopied: '🔗 Pack link copied and QR generated!'
    },
    dynamic: {
      wordAdded: ({ word, category }) => `✅ Challenge added to ${category}: "${word}"`,
      correctScoreBreakdown: ({ base, speedBonus = 0, difficultyBonus = 0, hintPenalty = 0, comboMultiplier = 1, total }) => {
        const parts = [`Base ${base}`];
        if (speedBonus > 0) parts.push(`+ speed ${speedBonus}`);
        if (difficultyBonus > 0) parts.push(`+ difficulty ${difficultyBonus}`);
        if (hintPenalty > 0) parts.push(`- hint ${hintPenalty}`);
        if (comboMultiplier > 1) parts.push(`x combo ${comboMultiplier}`);
        return parts.length > 1 ? `${parts.join(' ')} = ${total}` : parts[0];
      },
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} for ${playerName} and ${teamName}!`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} for ${playerName}!`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Steal: +${points} for ${playerName} and ${teamName}!`,
      stealPlayerPoints: ({ playerName, points }) => `Steal: +${points} for ${playerName}!`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder daily ${date} · Winner: ${winner} · ${score}`
    },
    settings: {
      speedBonusLabel: 'Speed bonus',
      speedBonusSub: 'Adds extra points for fast correct answers',
      speedBonusMaxLabel: 'Maximum bonus',
      speedBonusMaxSub: 'Extra points for solving early in the timer',
      wrongPenaltyPointsSub: 'Subtracts points when the answer is wrong or time runs out. Use 0 to disable.'
    },
    result: {
      correctTitle: 'Correct!',
      wrongTitle: 'Wrong!',
      feedbackTitle: 'How was this challenge?',
      feedbackSubtitle: 'Your local rating helps prioritize better challenges.',
      answerReveal: ({ answer }) => `Answer: ${answer}`,
      guesserLabel: 'Who solved first?',
      guesserPlaceholder: 'Select who solved it',
      buzzPickPrompt: 'Pick who solved first to apply the points.',
      stealTitle: 'Steal available',
      stealSummary: ({ playerName, points }) => `${playerName} may steal ${points} points.`,
      stealButton: '⚡ Steal solved',
      shareDailyResult: 'Share daily result'
    },
    achievements: {
      laughsLabel: 'Correct answers',
      items: {
        firstLaugh: { title: 'First Solve', desc: 'Decode your first challenge.' },
        firstNoLaugh: { title: 'First Miss', desc: 'Record your first round without a correct answer.' },
        humorBeginner: { title: 'Rookie Decoder', desc: 'Collect 10 correct answers.' },
        laughterMachine: { title: 'Master Decoder', desc: 'Collect 50 correct answers.' },
        jokeMarathon: { title: 'Emoji Marathon', desc: 'Play 100 rounds.' },
        funnyStreak: { title: 'Solve Streak', desc: 'Get 3 correct answers in a row.' },
        unstoppable: { title: 'Unstoppable', desc: 'Get 5 correct answers in a row.' }
      },
      templates: {
        laughsTitle: ({ count }) => `Correct x${count}`,
        laughsDesc: ({ count }) => `Collect ${count} correct answers.`,
        noLaughsTitle: ({ count }) => `Misses x${count}`,
        noLaughsDesc: ({ count }) => `Record ${count} rounds without a correct answer.`,
        streakDesc: ({ count }) => `Get ${count} correct answers in a row.`
      }
    },
    share: {
      title: 'EmojiDecoder',
      text: 'Come play EmojiDecoder with me!',
      footerAriaLabel: 'Share EmojiDecoder'
    },
    footer: {
      copyPrefix: '© 2026 EmojiDecoder v0.1 · Insight X Lab Technologies'
    },
    userIdErrors: {
      invalidSchema: 'This file is not an EmojiDecoder user_id backup.'
    }
  };

  const createEmojiDecoderLocalePatch = ({
    subtitle,
    categories,
    currentPlayerLabel,
    revealWord,
    ...
    curationAllStats,
    packCreatorTitle,
    packCreatorNamePlaceholder,
    packCreatorDescriptionPlaceholder,
    packCreatorSub,
    exportLocalPack,
    shareLocalPack,
    duplicateWord,
    ...
    dailyResultCopied,
    localPackExported,
    localPackShareCopied,
    wordAdded,
    scoreBaseLabel,
    scoreSpeedLabel,
    scoreDifficultyLabel,
    scoreHintLabel,
    buzzCorrectTeamPoints,
    buzzCorrectPlayerPoints,
    stealTeamPoints,
    stealPlayerPoints,
    dailyShareText,
    correctPointsLabel,
    ...
    meta: { documentTitle: 'EmojiDecoder' },
    home: { title: 'EmojiDecoder', subtitle },
    category: categories,
    setup: { buzzModeLabel, buzzModeSub, stealModeLabel, stealModeSub, comboModeLabel, comboModeSub, typedGuessModeLabel, typedGuessModeSub, dailyChallengeLabel, dailyChallengeSub, difficultySub, scoringTradeoff },
    game: {
      currentPlayerLabel,
      revealWord,
      correct,
      ...
      secretAnswerSub,
      secretAnswerCompanionSub,
      hintPrefix: ({ hint }) => `${hintLabel}: ${hint}`,
      rulePrefix: ({ rule }) => `${ruleLabel}: ${rule}`,
      requestHint,
      hintRequested,
      hintCost,
      typedGuessPlaceholder,
      submitTypedGuess,
      wordOnCompanion: 'EmojiDecoder',
      challengePrefix: '🧭'
    },
    multiDevice: {
      guestSecretAnswer,
      guestAnswerRevealed: answerRevealed
    },
    result: {
      correctTitle,
      wrongTitle,
      ...
      stealButton,
      shareDailyResult,
      answerReveal: ({ answer }) => `${answerLabel}: ${answer}`
    },
    leaderboard: {
      filter: {
        scope: leaderboardScope,
        standard: leaderboardStandard,
        standardSub: leaderboardStandardSub,
        daily: leaderboardDaily,
        dailySub: leaderboardDailySub
      }
    },
    achievements: { laughsLabel: achievementsLabel },
    wordbank: {
      addTitle,
      newWordPlaceholder: cluePlaceholder,
      newAnswerPlaceholder: answerPlaceholder,
      newHintPlaceholder: hintPlaceholder,
      addButton,
      listTitle,
      answerMeta: ({ answer }) => `${answerLabel}: ${answer}`,
      hintMeta: ({ hint }) => `${hintLabel}: ${hint}`,
      emptyCategory,
      challengesEmpty,
      installPackSub,
      jokeRankingTitle: rankingTitle,
      curationTopRated,
      curationHighSuccess,
      curationNeedsReview,
      curationNeverAgain,
    ...
    settings: {
      ...
      speedBonusMaxLabel,
      speedBonusMaxSub,
      wrongPenaltyPointsLabel: wrongPointsLabel,
      wrongPenaltyPointsSub: wrongPointsSub,
      roundFlowSub
    },
    notifications: {
      duplicateWord,
      challengeFieldsRequired: requiredFields,
      guessIncorrect,
      guessSent,
      dailyResultCopied,
      localPackExported,
    ...
    dynamic: {
      wordAdded: ({ word, category }) => wordAdded(word, category),
      correctScoreBreakdown: ({ base, speedBonus = 0, difficultyBonus = 0, hintPenalty = 0, comboMultiplier = 1, total }) => {
        const parts = [`${scoreBaseLabel} ${base}`];
        if (speedBonus > 0) parts.push(`+ ${scoreSpeedLabel} ${speedBonus}`);
        if (difficultyBonus > 0) parts.push(`+ ${scoreDifficultyLabel} ${difficultyBonus}`);
        if (hintPenalty > 0) parts.push(`- ${scoreHintLabel} ${hintPenalty}`);
        if (comboMultiplier > 1) parts.push(`x combo ${comboMultiplier}`);
        return parts.length > 1 ? `${parts.join(' ')} = ${total}` : parts[0];
      },
      buzzCorrectTeamPoints,
    ...
    share: {
      title: 'EmojiDecoder',
      text: shareText,
      footerAriaLabel: 'EmojiDecoder'
    },
    footer: {
      copyPrefix: '© 2026 EmojiDecoder v0.1 · Insight X Lab Technologies'
    },
    userIdErrors: {
      invalidSchema: 'EmojiDecoder user_id'
    }
  });

  const emojiDecoderLocalePatches = {
    es: createEmojiDecoderLocalePatch({
      subtitle: 'Descifra emojis, revela respuestas y gana la ronda',
      categories: {
        objetos: { plural: 'Objetos', singular: 'Objeto', tab: '🧩 Objetos', option: '🧩 Objetos' },
        pessoas: { plural: 'Personas', singular: 'Persona', tab: '🧑 Personas', option: '🧑 Personas' },
        filmes_series: { plural: 'Películas y Series', singular: 'Película o Serie', tab: '🎬 Películas y Series', option: '🎬 Películas y Series' },
        lugares: { plural: 'Lugares', singular: 'Lugar', tab: '🗺️ Lugares', option: '🗺️ Lugares' },
        marcas: { plural: 'Marcas', singular: 'Marca', tab: '🏷️ Marcas', option: '🏷️ Marcas' },
        expressoes: { plural: 'Expresiones', singular: 'Expresión', tab: '💬 Expresiones', option: '💬 Expresiones' }
      },
      currentPlayerLabel: 'Turno de descifrar:',
      revealWord: '🎲 Sortear desafío',
      correct: '✅ ¡Correcto!',
      wrong: '❌ Falló',
      secretAnswerLabel: 'Nombre secreto',
      secretAnswerSub: 'Muestra esta respuesta solo a quien validará la ronda.',
      secretAnswerCompanionSub: 'No muestres esta pantalla a quien intenta acertar.',
      guestSecretAnswer: 'Nombre secreto para validar',
      answerRevealed: 'Respuesta revelada',
      hintLabel: 'Pista',
      requestHint: ({ points }) => `💡 Pedir pista (-${points} pts)`,
      hintRequested: '💡 Pista usada',
      hintCost: ({ points }) => `La pista reduce ${points} puntos del acierto.`,
      typedGuessPlaceholder: 'Escribe el intento...',
      submitTypedGuess: '⌨️ Validar intento',
      ruleLabel: 'Regla',
      correctTitle: '¡Correcto!',
      wrongTitle: '¡Falló!',
      timeUpTitle: '¡Tiempo agotado!',
      feedbackTitle: '¿Qué tal fue este desafío?',
      feedbackSubtitle: 'Tu valoración local ayuda a priorizar mejores desafíos.',
      guesserLabel: '¿Quién acertó primero?',
      guesserPlaceholder: 'Selecciona quién acertó',
      buzzPickPrompt: 'Elige quién acertó primero para aplicar los puntos.',
      stealTitle: 'Robo disponible',
      stealSummary: ({ playerName, points }) => `${playerName} puede robar ${points} puntos.`,
      stealButton: '⚡ Robo acertado',
      shareDailyResult: 'Compartir diario',
      leaderboardScope: 'Alcance',
      leaderboardStandard: 'Partidas',
      leaderboardStandardSub: 'Ranking de partidas normales',
      leaderboardDaily: 'Diario',
      leaderboardDailySub: 'Ranking de desafíos diarios',
      answerLabel: 'Respuesta',
      addTitle: '➕ Añadir desafío',
      cluePlaceholder: 'Escribe los emojis del desafío...',
      answerPlaceholder: 'Escribe la respuesta correcta...',
      hintPlaceholder: 'Escribe una pista corta...',
      addButton: '➕ Añadir desafío',
      listTitle: '📋 Desafíos',
      emptyCategory: 'Aún no hay desafíos en esta categoría.',
      challengesEmpty: 'No hay reglas de respuesta activas. Restaura o añade una nueva.',
      installPackSub: 'Envía un archivo .json para liberar nuevos desafíos en este dispositivo.',
      rankingTitle: '🏅 Ranking local de desafíos',
      curationTopRated: 'Mejor evaluados',
      curationHighSuccess: 'Alta tasa de acierto',
      curationNeedsReview: 'Revisar contenido',
      curationNeverAgain: 'Marcados como no repetir',
      curationAllStats: 'Todos con estadísticas',
      packCreatorTitle: '🧰 Creador de packs',
      packCreatorNamePlaceholder: 'Nombre del pack...',
      packCreatorDescriptionPlaceholder: 'Descripción corta...',
      packCreatorSub: 'Exporta desafíos locales en schema v1 para importar en otro dispositivo.',
      exportLocalPack: 'Exportar pack JSON',
      shareLocalPack: 'Compartir por enlace/QR',
      duplicateWord: '⚠️ El desafío ya existe.',
      requiredFields: '⚠️ Informa emojis y respuesta.',
      guessIncorrect: '❌ Intento incorrecto.',
      guessSent: '📨 Intento enviado al host.',
      dailyResultCopied: '✅ Resultado diario copiado.',
      localPackExported: '✅ Pack local exportado.',
      localPackShareCopied: '🔗 Enlace del pack copiado y QR generado.',
      wordAdded: (word, category) => `✅ Desafío añadido a ${category}: "${word}"`,
      scoreBaseLabel: 'Base',
      scoreSpeedLabel: 'velocidad',
      scoreDifficultyLabel: 'dificultad',
      scoreHintLabel: 'pista',
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} para ${playerName} y ${teamName}!`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} para ${playerName}!`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Robo: +${points} para ${playerName} y ${teamName}!`,
      stealPlayerPoints: ({ playerName, points }) => `Robo: +${points} para ${playerName}!`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder diario ${date} · Ganador: ${winner} · ${score}`,
      correctPointsLabel: 'Puntos por acierto',
      correctPointsSub: 'Puntos para quien descifra correctamente',
      speedBonusLabel: 'Bono por velocidad',
      speedBonusSub: 'Da puntos extra por aciertos rápidos',
      speedBonusMaxLabel: 'Bono máximo',
      speedBonusMaxSub: 'Puntos extra al acertar al principio del temporizador',
      wrongPointsLabel: 'Puntos perdidos por error',
      wrongPointsSub: 'Descuenta puntos al fallar o agotar el tiempo. Usa 0 para desactivar.',
      roundFlowSub: 'Preparación corta, desafío visible y marca rápida de acierto',
      buzzModeLabel: 'Modo Disputa',
      buzzModeSub: 'Todos pueden responder; en el resultado el host elige quién acertó primero.',
      stealModeLabel: 'Modo Robo',
      stealModeSub: 'Cuando nadie acierta, el siguiente jugador puede robar la mitad de los puntos.',
      comboModeLabel: 'Modo Combo',
      comboModeSub: 'Los aciertos consecutivos del mismo jugador multiplican la puntuación, y un fallo reinicia la racha.',
      typedGuessModeLabel: 'Intento escrito',
      typedGuessModeSub: 'Valida texto ignorando mayúsculas, acentos y artículos.',
      dailyChallengeLabel: 'Desafío diario',
      dailyChallengeSub: 'Usa el mismo conjunto del día y lo guarda en la clasificación diaria.',
      difficultySub: 'Filtra desafíos y ajusta el bono de puntuación.',
      scoringTradeoff: 'Los aciertos rápidos suman bonos; pedir pista y fallar reducen puntos. Usa 0 en Configuración para desactivar la penalización.',
      achievementsLabel: 'Aciertos acumulados',
      shareText: '¡Ven a jugar EmojiDecoder conmigo!'
    }),
    fr: createEmojiDecoderLocalePatch({
      subtitle: 'Décodez des emojis, révélez les réponses et gagnez la manche',
      categories: {
        objetos: { plural: 'Objets', singular: 'Objet', tab: '🧩 Objets', option: '🧩 Objets' },
        pessoas: { plural: 'Personnes', singular: 'Personne', tab: '🧑 Personnes', option: '🧑 Personnes' },
        filmes_series: { plural: 'Films et Séries', singular: 'Film ou Série', tab: '🎬 Films et Séries', option: '🎬 Films et Séries' },
        lugares: { plural: 'Lieux', singular: 'Lieu', tab: '🗺️ Lieux', option: '🗺️ Lieux' },
        marcas: { plural: 'Marques', singular: 'Marque', tab: '🏷️ Marques', option: '🏷️ Marques' },
        expressoes: { plural: 'Expressions', singular: 'Expression', tab: '💬 Expressions', option: '💬 Expressions' }
      },
      currentPlayerLabel: 'Tour de décoder :',
      revealWord: '🎲 Tirer un défi',
      correct: '✅ Correct !',
      wrong: '❌ Raté',
      secretAnswerLabel: 'Nom secret',
      secretAnswerSub: 'Montrez cette réponse uniquement à la personne qui valide la manche.',
      secretAnswerCompanionSub: 'Ne montrez pas cet écran à la personne qui tente de répondre.',
      guestSecretAnswer: 'Nom secret pour validation',
      answerRevealed: 'Réponse révélée',
      hintLabel: 'Indice',
      requestHint: ({ points }) => `💡 Demander un indice (-${points} pts)`,
      hintRequested: '💡 Indice utilisé',
      hintCost: ({ points }) => `L’indice réduit la bonne réponse de ${points} points.`,
      typedGuessPlaceholder: 'Saisissez la réponse...',
      submitTypedGuess: '⌨️ Valider la réponse',
      ruleLabel: 'Règle',
      correctTitle: 'Correct !',
      wrongTitle: 'Raté !',
      timeUpTitle: 'Temps écoulé !',
      feedbackTitle: 'Comment était ce défi ?',
      feedbackSubtitle: 'Votre note locale aide à prioriser les meilleurs défis.',
      guesserLabel: 'Qui a trouvé en premier ?',
      guesserPlaceholder: 'Sélectionnez qui a trouvé',
      buzzPickPrompt: 'Choisissez qui a trouvé en premier pour appliquer les points.',
      stealTitle: 'Vol disponible',
      stealSummary: ({ playerName, points }) => `${playerName} peut voler ${points} points.`,
      stealButton: '⚡ Vol réussi',
      shareDailyResult: 'Partager le défi quotidien',
      leaderboardScope: 'Portée',
      leaderboardStandard: 'Parties',
      leaderboardStandardSub: 'Classement des parties normales',
      leaderboardDaily: 'Quotidien',
      leaderboardDailySub: 'Classement des défis du jour',
      answerLabel: 'Réponse',
      addTitle: '➕ Ajouter un défi',
      cluePlaceholder: 'Saisissez les emojis du défi...',
      answerPlaceholder: 'Saisissez la bonne réponse...',
      hintPlaceholder: 'Saisissez un indice court...',
      addButton: '➕ Ajouter un défi',
      listTitle: '📋 Défis',
      emptyCategory: 'Aucun défi dans cette catégorie pour le moment.',
      challengesEmpty: 'Aucune règle de réponse active. Restaurez ou ajoutez-en une.',
      installPackSub: 'Envoyez un fichier .json pour débloquer de nouveaux défis sur cet appareil.',
      rankingTitle: '🏅 Classement local des défis',
      curationTopRated: 'Mieux notés',
      curationHighSuccess: 'Taux de réussite élevé',
      curationNeedsReview: 'À réviser',
      curationNeverAgain: 'Marqués à ne pas répéter',
      curationAllStats: 'Tous avec statistiques',
      packCreatorTitle: '🧰 Créateur de packs',
      packCreatorNamePlaceholder: 'Nom du pack...',
      packCreatorDescriptionPlaceholder: 'Description courte...',
      packCreatorSub: 'Exporte les défis locaux au schéma v1 pour les importer sur un autre appareil.',
      exportLocalPack: 'Exporter le pack JSON',
      shareLocalPack: 'Partager par lien/QR',
      duplicateWord: '⚠️ Ce défi existe déjà.',
      requiredFields: '⚠️ Ajoutez les emojis et la réponse.',
      guessIncorrect: '❌ Réponse incorrecte.',
      guessSent: '📨 Réponse envoyée à l’hôte.',
      dailyResultCopied: '✅ Résultat quotidien copié.',
      localPackExported: '✅ Pack local exporté.',
      localPackShareCopied: '🔗 Lien du pack copié et QR généré.',
      wordAdded: (word, category) => `✅ Défi ajouté à ${category} : "${word}"`,
      scoreBaseLabel: 'Base',
      scoreSpeedLabel: 'vitesse',
      scoreDifficultyLabel: 'difficulté',
      scoreHintLabel: 'indice',
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} pour ${playerName} et ${teamName} !`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} pour ${playerName} !`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Vol : +${points} pour ${playerName} et ${teamName} !`,
      stealPlayerPoints: ({ playerName, points }) => `Vol : +${points} pour ${playerName} !`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder quotidien ${date} · Gagnant : ${winner} · ${score}`,
      correctPointsLabel: 'Points par bonne réponse',
      correctPointsSub: 'Points pour celui qui décode correctement',
      speedBonusLabel: 'Bonus de vitesse',
      speedBonusSub: 'Ajoute des points pour les bonnes réponses rapides',
      speedBonusMaxLabel: 'Bonus maximal',
      speedBonusMaxSub: 'Points bonus si la réponse arrive au début du minuteur',
      wrongPointsLabel: 'Points perdus par erreur',
      wrongPointsSub: 'Retire des points en cas d’erreur ou de temps écoulé. Mettez 0 pour désactiver.',
      roundFlowSub: 'Préparation courte, défi visible et validation rapide',
      buzzModeLabel: 'Mode duel',
      buzzModeSub: 'Tout le monde peut répondre; dans le résultat, l’hôte choisit qui a trouvé en premier.',
      stealModeLabel: 'Mode vol',
      stealModeSub: 'Si personne ne trouve, le joueur suivant peut voler la moitié des points.',
      comboModeLabel: 'Mode combo',
      comboModeSub: 'Les bonnes réponses consécutives du même joueur multiplient le score, et une erreur réinitialise la série.',
      typedGuessModeLabel: 'Réponse saisie',
      typedGuessModeSub: 'Valide le texte en ignorant majuscules, accents et articles.',
      dailyChallengeLabel: 'Défi quotidien',
      dailyChallengeSub: 'Utilise le même ensemble du jour et l’enregistre dans le classement quotidien.',
      difficultySub: 'Filtre les défis et ajuste le bonus de score.',
      scoringTradeoff: 'Les bonnes réponses rapides ajoutent un bonus; demander un indice et se tromper réduisent les points. Mettez 0 dans les paramètres pour désactiver la pénalité.',
      achievementsLabel: 'Bonnes réponses cumulées',
      shareText: 'Viens jouer à EmojiDecoder avec moi !'
    }),
    de: createEmojiDecoderLocalePatch({
      subtitle: 'Decodiere Emojis, decke Antworten auf und gewinne die Runde',
      categories: {
        objetos: { plural: 'Objekte', singular: 'Objekt', tab: '🧩 Objekte', option: '🧩 Objekte' },
        pessoas: { plural: 'Personen', singular: 'Person', tab: '🧑 Personen', option: '🧑 Personen' },
        filmes_series: { plural: 'Filme und Serien', singular: 'Film oder Serie', tab: '🎬 Filme und Serien', option: '🎬 Filme und Serien' },
        lugares: { plural: 'Orte', singular: 'Ort', tab: '🗺️ Orte', option: '🗺️ Orte' },
        marcas: { plural: 'Marken', singular: 'Marke', tab: '🏷️ Marken', option: '🏷️ Marken' },
        expressoes: { plural: 'Redewendungen', singular: 'Redewendung', tab: '💬 Redewendungen', option: '💬 Redewendungen' }
      },
      currentPlayerLabel: 'Decoder ist am Zug:',
      revealWord: '🎲 Herausforderung ziehen',
      correct: '✅ Richtig!',
      wrong: '❌ Falsch',
      secretAnswerLabel: 'Geheimer Name',
      secretAnswerSub: 'Zeige diese Antwort nur der Person, die die Runde prüft.',
      secretAnswerCompanionSub: 'Zeige diesen Bildschirm nicht der Person, die rät.',
      guestSecretAnswer: 'Geheimer Name zur Prüfung',
      answerRevealed: 'Antwort aufgedeckt',
      hintLabel: 'Hinweis',
      requestHint: ({ points }) => `💡 Hinweis anfordern (-${points} Pkt.)`,
      hintRequested: '💡 Hinweis genutzt',
      hintCost: ({ points }) => `Der Hinweis reduziert den Treffer um ${points} Punkte.`,
      typedGuessPlaceholder: 'Tipp eingeben...',
      submitTypedGuess: '⌨️ Tipp prüfen',
      ruleLabel: 'Regel',
      correctTitle: 'Richtig!',
      wrongTitle: 'Falsch!',
      timeUpTitle: 'Zeit abgelaufen!',
      feedbackTitle: 'Wie war diese Herausforderung?',
      feedbackSubtitle: 'Deine lokale Bewertung hilft, bessere Herausforderungen zu priorisieren.',
      guesserLabel: 'Wer war zuerst richtig?',
      guesserPlaceholder: 'Wähle, wer richtig lag',
      buzzPickPrompt: 'Wähle, wer zuerst richtig lag, um Punkte zu vergeben.',
      stealTitle: 'Steal verfügbar',
      stealSummary: ({ playerName, points }) => `${playerName} kann ${points} Punkte stehlen.`,
      stealButton: '⚡ Steal richtig',
      shareDailyResult: 'Tagesergebnis teilen',
      leaderboardScope: 'Bereich',
      leaderboardStandard: 'Partien',
      leaderboardStandardSub: 'Rangliste normaler Partien',
      leaderboardDaily: 'Täglich',
      leaderboardDailySub: 'Rangliste der Tagesherausforderungen',
      answerLabel: 'Antwort',
      addTitle: '➕ Herausforderung hinzufügen',
      cluePlaceholder: 'Emojis der Herausforderung eingeben...',
      answerPlaceholder: 'Richtige Antwort eingeben...',
      hintPlaceholder: 'Kurzen Hinweis eingeben...',
      addButton: '➕ Herausforderung hinzufügen',
      listTitle: '📋 Herausforderungen',
      emptyCategory: 'Noch keine Herausforderungen in dieser Kategorie.',
      challengesEmpty: 'Keine aktiven Rate-Regeln. Stelle sie wieder her oder füge eine neue hinzu.',
      installPackSub: 'Lade eine .json-Datei hoch, um neue Herausforderungen auf diesem Gerät freizuschalten.',
      rankingTitle: '🏅 Lokales Ranking der Herausforderungen',
      curationTopRated: 'Bestbewertet',
      curationHighSuccess: 'Hohe Trefferquote',
      curationNeedsReview: 'Inhalt prüfen',
      curationNeverAgain: 'Als nicht wiederholen markiert',
      curationAllStats: 'Alle mit Statistiken',
      packCreatorTitle: '🧰 Pack-Ersteller',
      packCreatorNamePlaceholder: 'Pack-Name...',
      packCreatorDescriptionPlaceholder: 'Kurze Beschreibung...',
      packCreatorSub: 'Exportiert lokale Herausforderungen im Schema v1 für den Import auf einem anderen Gerät.',
      exportLocalPack: 'JSON-Pack exportieren',
      shareLocalPack: 'Per Link/QR teilen',
      duplicateWord: '⚠️ Diese Herausforderung existiert bereits.',
      requiredFields: '⚠️ Emojis und Antwort angeben.',
      guessIncorrect: '❌ Falscher Tipp.',
      guessSent: '📨 Tipp an Host gesendet.',
      dailyResultCopied: '✅ Tagesergebnis kopiert.',
      localPackExported: '✅ Lokales Pack exportiert.',
      localPackShareCopied: '🔗 Pack-Link kopiert und QR erstellt.',
      wordAdded: (word, category) => `✅ Herausforderung zu ${category} hinzugefügt: "${word}"`,
      scoreBaseLabel: 'Basis',
      scoreSpeedLabel: 'Tempo',
      scoreDifficultyLabel: 'Schwierigkeit',
      scoreHintLabel: 'Hinweis',
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} für ${playerName} und ${teamName}!`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} für ${playerName}!`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Steal: +${points} für ${playerName} und ${teamName}!`,
      stealPlayerPoints: ({ playerName, points }) => `Steal: +${points} für ${playerName}!`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder täglich ${date} · Gewinner: ${winner} · ${score}`,
      correctPointsLabel: 'Punkte pro Treffer',
      correctPointsSub: 'Punkte für korrektes Decodieren',
      speedBonusLabel: 'Tempo-Bonus',
      speedBonusSub: 'Gibt Extrapunkte für schnelle richtige Antworten',
      speedBonusMaxLabel: 'Maximaler Bonus',
      speedBonusMaxSub: 'Extrapunkte bei früher Lösung im Timer',
      wrongPointsLabel: 'Punktverlust bei Fehler',
      wrongPointsSub: 'Zieht Punkte bei Fehlern oder Zeitablauf ab. Mit 0 deaktivieren.',
      roundFlowSub: 'Kurze Vorbereitung, sichtbare Herausforderung und schnelle Wertung',
      buzzModeLabel: 'Buzz-Modus',
      buzzModeSub: 'Alle dürfen antworten; im Ergebnis wählt der Host, wer zuerst richtig lag.',
      stealModeLabel: 'Steal-Modus',
      stealModeSub: 'Wenn niemand löst, kann der nächste Spieler die Hälfte der Punkte stehlen.',
      comboModeLabel: 'Combo-Modus',
      comboModeSub: 'Aufeinanderfolgende Treffer desselben Spielers multiplizieren die Punkte, ein Fehler setzt die Serie zurück.',
      typedGuessModeLabel: 'Getippter Tipp',
      typedGuessModeSub: 'Prüft Text ohne Beachtung von Großschreibung, Akzenten und Artikeln.',
      dailyChallengeLabel: 'Tagesherausforderung',
      dailyChallengeSub: 'Nutzt das gleiche Tages-Set und speichert es in der Tages-Bestenliste.',
      difficultySub: 'Filtert Herausforderungen und passt den Punktebonus an.',
      scoringTradeoff: 'Schnelle Treffer geben Bonuspunkte; Hinweise und Fehler reduzieren Punkte. Setze in den Einstellungen 0, um die Strafe zu deaktivieren.',
      achievementsLabel: 'Gesammelte Treffer',
      shareText: 'Spiel EmojiDecoder mit mir!'
    }),
    it: createEmojiDecoderLocalePatch({
      subtitle: 'Decifra emoji, rivela risposte e vinci il turno',
      categories: {
        objetos: { plural: 'Oggetti', singular: 'Oggetto', tab: '🧩 Oggetti', option: '🧩 Oggetti' },
        pessoas: { plural: 'Persone', singular: 'Persona', tab: '🧑 Persone', option: '🧑 Persone' },
        filmes_series: { plural: 'Film e Serie', singular: 'Film o Serie', tab: '🎬 Film e Serie', option: '🎬 Film e Serie' },
        lugares: { plural: 'Luoghi', singular: 'Luogo', tab: '🗺️ Luoghi', option: '🗺️ Luoghi' },
        marcas: { plural: 'Brand', singular: 'Brand', tab: '🏷️ Brand', option: '🏷️ Brand' },
        expressoes: { plural: 'Espressioni', singular: 'Espressione', tab: '💬 Espressioni', option: '💬 Espressioni' }
      },
      currentPlayerLabel: 'Turno di decifrare:',
      revealWord: '🎲 Estrai sfida',
      correct: '✅ Corretto!',
      wrong: '❌ Sbagliato',
      secretAnswerLabel: 'Nome segreto',
      secretAnswerSub: 'Mostra questa risposta solo a chi valida il turno.',
      secretAnswerCompanionSub: 'Non mostrare questa schermata a chi sta provando a indovinare.',
      guestSecretAnswer: 'Nome segreto per validazione',
      answerRevealed: 'Risposta rivelata',
      hintLabel: 'Indizio',
      requestHint: ({ points }) => `💡 Chiedi indizio (-${points} pt)`,
      hintRequested: '💡 Indizio usato',
      hintCost: ({ points }) => `L’indizio riduce la risposta corretta di ${points} punti.`,
      typedGuessPlaceholder: 'Digita il tentativo...',
      submitTypedGuess: '⌨️ Valida tentativo',
      ruleLabel: 'Regola',
      correctTitle: 'Corretto!',
      wrongTitle: 'Sbagliato!',
      timeUpTitle: 'Tempo scaduto!',
      feedbackTitle: 'Com’è stata questa sfida?',
      feedbackSubtitle: 'La valutazione locale aiuta a priorizzare sfide migliori.',
      guesserLabel: 'Chi ha indovinato per primo?',
      guesserPlaceholder: 'Seleziona chi ha indovinato',
      buzzPickPrompt: 'Scegli chi ha indovinato per primo per assegnare i punti.',
      stealTitle: 'Furto disponibile',
      stealSummary: ({ playerName, points }) => `${playerName} può rubare ${points} punti.`,
      stealButton: '⚡ Furto riuscito',
      shareDailyResult: 'Condividi giornaliero',
      leaderboardScope: 'Ambito',
      leaderboardStandard: 'Partite',
      leaderboardStandardSub: 'Classifica delle partite normali',
      leaderboardDaily: 'Giornaliero',
      leaderboardDailySub: 'Classifica delle sfide del giorno',
      answerLabel: 'Risposta',
      addTitle: '➕ Aggiungi sfida',
      cluePlaceholder: 'Digita gli emoji della sfida...',
      answerPlaceholder: 'Digita la risposta corretta...',
      hintPlaceholder: 'Digita un indizio breve...',
      addButton: '➕ Aggiungi sfida',
      listTitle: '📋 Sfide',
      emptyCategory: 'Nessuna sfida in questa categoria per ora.',
      challengesEmpty: 'Nessuna regola di risposta attiva. Ripristina o aggiungine una nuova.',
      installPackSub: 'Carica un file .json per sbloccare nuove sfide su questo dispositivo.',
      rankingTitle: '🏅 Classifica locale delle sfide',
      curationTopRated: 'Migliori valutazioni',
      curationHighSuccess: 'Alta percentuale di successo',
      curationNeedsReview: 'Da rivedere',
      curationNeverAgain: 'Segnati come non ripetere',
      curationAllStats: 'Tutti con statistiche',
      packCreatorTitle: '🧰 Creatore di pack',
      packCreatorNamePlaceholder: 'Nome del pack...',
      packCreatorDescriptionPlaceholder: 'Descrizione breve...',
      packCreatorSub: 'Esporta sfide locali nello schema v1 per importarle su un altro dispositivo.',
      exportLocalPack: 'Esporta pack JSON',
      shareLocalPack: 'Condividi con link/QR',
      duplicateWord: '⚠️ La sfida esiste già.',
      requiredFields: '⚠️ Inserisci emoji e risposta.',
      guessIncorrect: '❌ Tentativo errato.',
      guessSent: '📨 Tentativo inviato all’host.',
      dailyResultCopied: '✅ Risultato giornaliero copiato.',
      localPackExported: '✅ Pack locale esportato.',
      localPackShareCopied: '🔗 Link del pack copiato e QR generato.',
      wordAdded: (word, category) => `✅ Sfida aggiunta a ${category}: "${word}"`,
      scoreBaseLabel: 'Base',
      scoreSpeedLabel: 'velocità',
      scoreDifficultyLabel: 'difficoltà',
      scoreHintLabel: 'indizio',
      buzzCorrectTeamPoints: ({ playerName, teamName, points }) => `+${points} per ${playerName} e ${teamName}!`,
      buzzCorrectPlayerPoints: ({ playerName, points }) => `+${points} per ${playerName}!`,
      stealTeamPoints: ({ playerName, teamName, points }) => `Furto: +${points} per ${playerName} e ${teamName}!`,
      stealPlayerPoints: ({ playerName, points }) => `Furto: +${points} per ${playerName}!`,
      dailyShareText: ({ date, winner, score }) => `EmojiDecoder giornaliero ${date} · Vincitore: ${winner} · ${score}`,
      correctPointsLabel: 'Punti per risposta corretta',
      correctPointsSub: 'Punti per chi decifra correttamente',
      speedBonusLabel: 'Bonus velocità',
      speedBonusSub: 'Aggiunge punti extra per risposte corrette rapide',
      speedBonusMaxLabel: 'Bonus massimo',
      speedBonusMaxSub: 'Punti extra se risolvi all’inizio del timer',
      wrongPointsLabel: 'Punti persi per errore',
      wrongPointsSub: 'Sottrae punti in caso di errore o tempo scaduto. Usa 0 per disattivare.',
      roundFlowSub: 'Preparazione breve, sfida visibile e valutazione rapida',
      buzzModeLabel: 'Modalità Disputa',
      buzzModeSub: 'Tutti possono rispondere; nel risultato l’host sceglie chi ha indovinato per primo.',
      stealModeLabel: 'Modalità Furto',
      stealModeSub: 'Quando nessuno indovina, il giocatore successivo può rubare metà punti.',
      comboModeLabel: 'Modalità Combo',
      comboModeSub: 'Le risposte corrette consecutive dello stesso giocatore moltiplicano il punteggio, e un errore azzera la serie.',
      typedGuessModeLabel: 'Tentativo scritto',
      typedGuessModeSub: 'Valida il testo ignorando maiuscole, accenti e articoli.',
      dailyChallengeLabel: 'Sfida giornaliera',
      dailyChallengeSub: 'Usa lo stesso set del giorno e lo salva nella classifica giornaliera.',
      difficultySub: 'Filtra le sfide e regola il bonus punteggio.',
      scoringTradeoff: 'Le risposte rapide danno bonus; chiedere indizi e sbagliare riduce i punti. Usa 0 nelle impostazioni per disattivare la penalità.',
      achievementsLabel: 'Risposte corrette accumulate',
      shareText: 'Vieni a giocare a EmojiDecoder con me!'
    })
  };

  deepMerge(TRANSLATIONS.pt, emojiDecoderPtPatch);
  deepMerge(TRANSLATIONS.en, emojiDecoderEnPatch);
  Object.entries(emojiDecoderLocalePatches).forEach(([locale, patch]) => {
    deepMerge(TRANSLATIONS[locale], patch);
  });
